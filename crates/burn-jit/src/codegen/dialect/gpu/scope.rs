...
pub struct Scope {
    ...
    map: LazyProcesureMap,
}

#[derive(Clone, Default)]
struct LazyProcesureMap {
    map: Arc<RwLock<BTreeMap<u16, Box<dyn LazyProcedure>>>>,
}

impl LazyProcesureMap {}

impl core::fmt::Debug for LazyProcesureMap {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str("")
    }
}

impl PartialEq for LazyProcesureMap {
